    ...
    <div class="container mb-4">
    	...
    	<div class="row">
    		...
    		<div class="collapse navbar-collapse" id="navbarsExplore">
    			<ul class="navbar-nav">
    				<li class="nav-item">
    				<a class="nav-link" href="{{route('gallary.type', 'cars')}}">Cars</a>
    				</li>
    				<li class="nav-item">
    				<a class="nav-link" href="{{route('gallary.type', 'boats')}}">Boats</a>
    				</li>
    				<li class="nav-item">
    				<a class="nav-link" href="{{route('gallary.type', 'trucks')}}">Trucks</a>
    				</li>
    				<li class="nav-item">
    				<a class="nav-link" href="{{route('gallary.type', 'nature')}}">Nature</a>
    				</li>
    				<li class="nav-item dropdown">
    				...
    				<div class="dropdown-menu shadow-lg" aria-labelledby="dropdown01">
    					<a class="dropdown-item" href="{{route('gallary.type', 'portrait')}}">Portrait</a>
    					<a class="dropdown-item" href="{{route('gallary.type', 'people')}}">People</a>
    	...
    	<div class="row">
			...
			@foreach($users as $u)
    			<div class="card card-pin">
    				<a href="{{route('landing.imgView', $u->image)}}"><img class="card-img" src="{{asset('upload/'. $u->image)}}" alt="Card image">
    				<div class="overlay">
